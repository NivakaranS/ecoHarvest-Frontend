                        ...
                        <div className="w-[100%] mt-[10px] mb-[20px] h-[100%]">
                                ...
                                
                            {
                                cart && cart.products && cart.products.length > 0 ? (
                                    ...
                                    <div key={item._id} className="w-[100%] h-[120px] pl-[5px] pr-[20px] py-[4.5px] bg-white h-[100%]  rounded-[8px] ring-gray-500 ring-[0.5px] flex flex-row   justify-between ">
                                        ...
                                        <div className="py-[8px] leading-[24px]">
                                            ...
                                            <div className="flex flex-row items-center  space-x-[10px] ">
                                                <div className="bg-white ring-[1px] ring-gray-400 h-[30px] mt-[10px] ml-[10px] w-[90px] rounded-[5px] flex flex-row items-center justify-center">
                                                    <div onClick={() => handleDecreaseQuantity(item.id)} className="px-[10px] cursor-pointer h-[100%] flex items-center justify-center">
                                                ...
                                                {updateBtnVisible?
                                                    <div onClick={() => handleUpdateCart( cart._id, product._id, item.quantity)} className="bg-gray-400 ring-[0.5px] ring-gray-800 mt-[10px] cursor-pointer px-[20px] rounded-[4px] text-[15px] py-[2px]">
                                                    <p>Upate</p>
                                                </div>: null}
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-col leading-[22px]">
                                            ...
                                            <div onClick={() => handleDeleteProduct(cart._id, product._id)} className="cursor-pointer w-fit">
