                ...
                <div className="bg-gray-200 rounded-[10px] pb-[10px] pt-[12px] px-[15px] w-[70%] ">
                    ...
                    <div className='flex flex-col px-[15px] rounded-[10px] py-[10px] mt-[10px] bg-white'>
                        ...
                        <div>
                            ...
                            <div className='w-[100%] bg-gray-500 h-[0.5px] mt-[5px]'>
                ...
                <div className=" pt-[10px] pb-[0px] px-[15px] bg-gray-200 rounded-[10px] h-[100%] w-[40%]">
                    ...
                    <div className='bg-white rounded-[10px] mt-[5px] px-[10px] py-[5px] '>
                        ...
                        <div className='flex text-gray-700 flex-row items-center  mb-[5px] text-[11px]'>
                            ...
                            <div className='w-[120px]'>
                                <Select classNames={{
                                    control: () => "bg-white h-3 min-h-0 border-red-300 hover:border-blue-500",
                                    menu: () => "bg-white he- border border-gray-200 shadow-lg rounded-lg",
                                    option: ({ isFocused, isSelected }) =>
                                      `cursor-pointer  ${isSelected ? "bg-blue-500 text-white" : isFocused ? "bg-gray-200" : "bg-white"}`, 
                                    valueContainer: () => "py-0",
                                    input: () => "py-0"
                                }} options={options} />
                            </div>
                    ...
                    <div className='mt-[10px] '>
                        ...
                        <div className='bg-white rounded-[10px] mt-[5px] px-[10px] py-[10px] '>
                            ...
                            <div className='text-[12px] flex flex-col  my-[10px]'>
                                <p>Guest Name</p>
                                <input className='mt-[5px] ring-1 focus:outline-none ring-gray-500 w-[91%] py-[5px] px-[10px] rounded ' placeholder='Guest name' />
                            </div>
