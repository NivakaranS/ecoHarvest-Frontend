                ...
                <div className='w-[43%]'>
                    ...
                    <div className='flex flex-col space-y-[17px]'>
                        <div className='flex relative flex-col'>
                            ...
                            <input type='text' value={username} onChange={(e) => setUsername(e.target.value)}  className=' ring-[0.5px] rounded-[5px] py-[5px] px-[10px] focus:outline-none' placeholder='' />
                        </div>
                        <div className='flex relative flex-col'>
                            <label className='absolute top-[-13px] left-[10px] px-[3px] bg-gray-200'>Password</label>
                            <input type='text' value={password} onChange={(e) => setPassword(e.target.value)}  className=' ring-[0.5px] rounded-[5px] py-[5px] px-[10px] focus:outline-none' placeholder='' />
