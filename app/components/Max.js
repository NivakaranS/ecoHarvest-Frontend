...
const Max = () => {
    ...
    return (
        <div className={`${max? 'h-[100vh] w-[100vw]' : '' } fixed text-black bottom-[0px] right-[0px]  `}>
            ...
            <div onClick={handleMax} className={`${max ? ' translate-y-[100px] ' : 'translate-y-[0px] delay-300'} select-none transition-transform duration-500 ease-in-out absolute bottom-[20px] right-[30px] flex items-center justify-center w-fit bg-[#FDAA1C] rounded-full ring-[0.5px] ring-gray-800 cursor-pointer px-[30px] py-[5px]  `}>
                <p className="select-none text-[20px]">Max</p>
            </div>

            <div className={`${max ? 'scale-[100%] delay-200' : 'scale-0' } absolute bottom-[20px] right-[30px] origin-bottom-right transition-transform duration-500 ease-in-out flex flex-col bg-[#FDAA1C] h-[500px] w-[350px] rounded-[10px] ring-[0.5px] ring-gray-800  justify-center mt-[5px]`}>
                ...
                <div className="w-[100%] relative rounded-b-[10px] p-[10px] h-[130px] bg-[#1D1D1D]">
                    ...
                    <div onClick={() => onMessageSubmit(message)} className="w-[70px] ring-[0.5px] ring-gray-800 cursor-pointer hover:bg-yellow-400 absolute top-[5px] right-[-20px] h-[70px] rounded-full bg-[#FDAA1C] flex items-center justify-center cursor-pointer mt-[10px]">
